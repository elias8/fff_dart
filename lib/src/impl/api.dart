...
import '../bindings/health_check.dart' as health_check_bindings;
...
import '../bindings/types/health_check.dart' show HealthCheck;
...
export '../bindings/types/grep.dart'
    show
        ...
        GrepResult,
        MultiGrepOptions;
export '../bindings/types/health_check.dart'
    show
        DatabaseHealth,
